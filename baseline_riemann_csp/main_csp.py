...
class CSP_Model:
	...
	def __init__(self,num_classes=4):
		...
		self.NO_subjects = 1
		self.NO_csp = N_CSP[num_classes] # Total number of CSP feature per band and timewindow
		self.useCSP = True
	...
	def run_csp(self):
		...
		if self.useCSP: 
			w = generate_projection(self.train_data,self.train_label, self.NO_csp,self.filter_bank,
				self.time_windows, NO_classes = self.num_classes)
		else: 
