        ...
        for sub_idx in test_global:
            ...
            for train_sub, test_sub in kf_subject.split(X_sub, y_sub):
                ...
                for j, lrate in enumerate(lrates):
                    ...
                    history = model.fit(X_Train_real[train_global], y_Train_cat[train_global], 
                            validation_data=(X_Train_real[test_global], y_Train_cat[test_global]),
