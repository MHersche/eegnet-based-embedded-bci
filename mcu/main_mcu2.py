...
# Set data parameters
extra_string ="first"
duration_datagetter = 2 # duration of the events that we get from the data getter
n_classes = 4 # can be 2, 3, 4
channel_size = 64 # look for 64, 32, 16, 8
ds_factor = 1# downsampling factor LOOK For: 2,3,4
PATH = "../../files/"
MODEL_NAME = f'{n_classes}class_{channel_size}ch_freqfactor{ds_factor}_duration_{extra_string}_{duration_datagetter}'
...
if True:
    ...
    X_Train_reduced = X_Train_downsampled[:,:,:320]
